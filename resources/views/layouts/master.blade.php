...
<head>
    ...
    <meta property="og:site_name" content="Mentoring CBT UIN" />
    ...
    <style>
        ...
        .nav-link span {
            display: block;
            font-size: 12px;
            margin-top: 4px; /* Jarak antara ikon dan teks */
        }
    </style>
</head>
<!--end::Head-->
        ...
        <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
            ...
            <div id="kt_app_header" class="app-header" data-kt-sticky="true"
                ...
                <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
                    id="kt_app_header_container" style="background-color: #31734A">
            ...
            <div class="row w-100">
                <div class="col text-center">
                    <a href="{{ route('dashboard') }}" class="nav-link">
                        <i class="la la-home fa-lg"></i>
                        <span>Dashboard</span>
                    </a>
                </div>
                <div class="col text-center">
                    <a href="{{ route('profil.edit') }}" class="nav-link">
                        <i class="la la-user fa-lg"></i>
                        <span>Profil</span>
                    </a>
                </div>
                <div class="col text-center">
                    <a href="{{ route('lihat-jadwal') }}" class="nav-link">
                        <i class="la la-calendar fa-lg"></i>
                        <span>Jadwal</span>
                    </a>
                </div>
                <div class="col text-center">
                    <a href="{{ route('mentoring.index') }}" class="nav-link">
                        <i class="la la-file fa-lg"></i>
                        <span>Resolusi</span>
                    </a>
                </div>
                <div class="col text-center">
                    <a href="{{ route('absensi.index') }}" class="nav-link">
                        <i class="la la-file-text fa-lg"></i>
                        <span>Absensi</span>
                    </a>
                </div>
            </div>
