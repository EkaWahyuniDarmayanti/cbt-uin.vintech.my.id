    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Resolusi Mahasiswa</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Resolusi Mahasiswa</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Add customer-->
                        <a href="{{ route('mentoring.cetak-admin') }}" class="btn btn-success">Cetak</a>
                        <!--end::Add customer-->
                    </div>
                    <!--end::Card toolbar-->
                    @endif
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                        <thead>
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-150px" style="text-align: center">Total Resolusi</th>
                                <th class="text-center min-w-100px">Lengkap/Belum Lengkap</th>
                                <th>Cetak</th>
                            </tr>
                        </thead>
                        <tbody class="fw-semibold text-gray-600">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center">
                                    <span class="badge badge-primary">{{ $totalMentoring[$item->mahasiswa_id] }}</span>
                                </td>
                                <td class="text-center">
                                    ...
                                    @endif --}}
                                    <a href="{{ route('mentoring.detail', $item->mahasiswa_id) }}" class="btn btn-success btn-flex btn-active-light-primary h-30px me-3" data-bs-toggle="tooltip" title="Detail">
                                ...
                                <td class="text-center">
                                    <a href="{{ route('mentoring.cetak-mahasiswa', $item->mahasiswa->id) }}" class="btn btn-icon"><i class="ki-outline ki-printer fs-2"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
